namespace Ordering.WebApi.Controllers.v1
{
    ...
    public class SamplesController: ControllerBase
    {
        ...
        {
            // add error handling
            var query = new GetSampleList.SampleListQuery(sampleParametersDto);
        ...
        {
            // add error handling
            var query = new GetSample.SampleQuery(sampleId);
            var queryResponse = await _mediator.Send(query);
        ...
        {
            // add error handling
            var command = new AddSample.AddSampleCommand(sampleForCreation);
        ...
        {
            // add error handling
            var command = new UpdateSample.UpdateSampleCommand(sampleId, sample);
            await _mediator.Send(command);
