        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // Entity Context - Do Not Delete
                ...
                using (var context = app.ApplicationServices.GetService<OrderingDbContext>())
                {
                    ...
                    PatientSeeder.SeedSamplePatientData(app.ApplicationServices.GetService<OrderingDbContext>());                    SampleSeeder.SeedSampleSampleData(app.ApplicationServices.GetService<OrderingDbContext>());
                }
