namespace Ordering.IntegrationTests.FeatureTests.Sample
{
    ...
    public class SampleListQueryTests : TestBase
    {
        ...
        public async Task SampleListQuery_Returns_Resource_With_Accurate_Props()
        {
            ...
            // Act
            var query = new GetSampleList.SampleListQuery(queryParameters);
        ...
        [Test]
        public async Task SampleListQuery_Throws_ApiException_When_Null_Query_Parameters()
        {
            // Arrange
            // N/A

            // Act
            var query = new GetSampleList.SampleListQuery(null);
