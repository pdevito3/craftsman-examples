...
namespace Reporting.IntegrationTests.TestUtilities
{
    using Docker.DotNet;
    ...
    public static class DockerSqlDatabaseUtilities
    {
        ...
        public const string DB_CONTAINER_NAME = "IntegrationTestingContainer_Reporting";
        public const string DB_VOLUME_NAME = "IntegrationTestingVolume_Reporting";
